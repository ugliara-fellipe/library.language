...
1. [Fork](http://help.github.com/fork-a-repo/) the repo, clone your fork,
   ...
   git clone https://github.com/ugliara-fellipe/library.language
   # Navigate to the newly cloned directory
   cd library.language
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/<upsteam-owner>/library.language
   ```
...
4. Commit your changes in logical chunks. Please adhere to these [git commit
   message guidelines](https://github.com/ugliara-fellipe/library.language/blob/master/.gitcommit)
...
[Code of Conduct](https://github.com/ugliara-fellipe/library.language/blob/master/.github/CODE_OF_CONDUCT.md)
